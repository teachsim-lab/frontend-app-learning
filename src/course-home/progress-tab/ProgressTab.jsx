    ...
    <>
      ...
      <div className="row w-100 m-0">
        ...
        <div className="col-12 col-md-8 p-0">
          ...
          {/* TeachSim customization: only show grade/certificate-status
              sections when the course actually has an active certificate
              configured - otherwise keep the pre-existing progress-only
              behavior (see README/PDF item 3). */}
          {hasActiveCertificate && <ProgressTabCertificateStatusMainBodySlot />}
          {hasActiveCertificate && <ProgressTabCourseGradeSlot />}
          <ProgressTabGradeBreakdownSlot />
        </div>

        {/* Side panel */}
        <div className="col-12 col-md-4 p-0 px-md-4">
          {hasActiveCertificate && <ProgressTabCertificateStatusSidePanelSlot />}
